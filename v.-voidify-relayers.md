...
Once your relayer service is running and accessible via HTTPS, register on-chain on frontend(voidifycto.4sol.xyz)\
-> [Twitter video](https://x.com/VoidifyCTO/status/2041206994493935888)

Registration is live at [https://voidifycto.4sol.xyz](https://voidifycto.4sol.xyz).
...
当 relayer 服务运行并可通过 HTTPS 访问后，在前端（voidifycto.4sol.xyz）进行链上注册。\
-> [Twitter video](https://x.com/VoidifyCTO/status/2041206994493935888)

Relayer 注册现已开放：[https://voidifycto.4sol.xyz](https://voidifycto.4sol.xyz)。
...
После запуска relayer и доступности сервиса через HTTPS зарегистрируйтесь on-chain во frontend(voidifycto.4sol.xyz)\
-> [Twitter video](https://x.com/VoidifyCTO/status/2041206994493935888)

Регистрация relayer уже доступна на [https://voidifycto.4sol.xyz](https://voidifycto.4sol.xyz).
...
Relayer サービスが起動し HTTPS でアクセスできる状態になったら、frontend(voidifycto.4sol.xyz) でオンチェーン登録します。\
-> [Twitter video](https://x.com/VoidifyCTO/status/2041206994493935888)

Relayer の登録は [https://voidifycto.4sol.xyz](https://voidifycto.4sol.xyz) で利用できます。
